...
st.title('Outil 1 : Transformation Europresse/Factiva HTML vers CSV')
st.write("Les fichiers doivent être en HTML dans le format de sortie d'Europresse/version classique ou Factiva")
st.write("Attention de bien sélectionner soit Europresse soit Factiva en fonction des sources")
st.write("Le traitement utilise BeautifulSoup / Pandas / Streamlit")
st.write("*Attention : certaines sources non journalistiques comme Agrobusiness report ne sont pas très bien parsées (champs nuls dans le tableau final)*")
...
format_date = st.selectbox("Format de la date",("AAAA-MM-JJ","AAAA","JJ/MM/AAAA"))
...
st.markdown("Pour tout problème, merci d'ouvrir une issue https://github.com/emilienschultz/dstool/issues")